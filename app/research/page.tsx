...
export default function Research() {
  return <main id="main-content">
    ...
    <ResearchStory id="good-life">
      <p>Measures of satisfaction, mastery, and stable relationships mostly assess how well people are doing within their existing activities and relationships. They can miss the value of learning new things, working with someone unfamiliar, or seeking new experiences. In my research, these forms of exploration were more closely associated with psychological richness—seeing one’s life as varied, interesting, and perspective-changing—than with happiness or meaning.</p>
      ...
      <ManuscriptLinks ids={['richness-and-exploration', 'missing-half', 'historical-good-life']} />
