...
export default function About() {
  return <main id="main-content">
    ...
    <div className="prose about-story">
      ...
      <p>My current dream is to become a good psychologist. One day, I hope my research on how environments shape the mind will lead me to become an architect, too.</p>
